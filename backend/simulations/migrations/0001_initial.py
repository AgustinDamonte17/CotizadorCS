    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('energy_charge_peak', models.DecimalField(decimal_places=4, max_digits=8, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Cargo Energía Pico (ARS/kWh)')),
                ('energy_charge_valley', models.DecimalField(decimal_places=4, max_digits=8, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Cargo Energía Valle (ARS/kWh)')),
                ('fixed_charge_monthly', models.DecimalField(decimal_places=2, max_digits=8, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Cargo Fijo Mensual (ARS)')),
                ('peak_percentage', models.DecimalField(decimal_places=2, default=30, max_digits=5, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)], verbose_name='Porcentaje Consumo Pico (%)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('monthly_consumption_kwh', models.DecimalField(decimal_places=2, max_digits=8, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Consumo Mensual (kWh)')),
                ('simulation_type', models.CharField(choices=[('coverage', 'Por Porcentaje de Cobertura'), ('panels', 'Por Cantidad de Paneles'), ('investment', 'Por Monto de Inversión')], max_length=20, verbose_name='Tipo de Simulación')),
                ('coverage_percentage', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)], verbose_name='Porcentaje de Cobertura (%)')),
                ...
                ('coverage_achieved', models.DecimalField(decimal_places=2, max_digits=5, validators=[django.core.validators.MinValueValidator(0)], verbose_name='Cobertura Lograda (%)')),
